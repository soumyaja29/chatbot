// SummarizeConversation flow provides a summary of the conversation history.
// It exports the SummarizeConversationInput and SummarizeConversationOutput types, and the summarizeConversation function.
'use server';
...
const SummarizeConversationInputSchema = z.object({
  conversationHistory: z.string().describe('The complete conversation history to summarize.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following conversation history into key points:\n\n{{conversationHistory}}`,
});
